...
> KBL 팬이 팀과 경기를 고르면 경기 summary와 오늘 잘한 선수를 보여주고, 해당 경기 출전 선수 기반 AI 하이라이트와 쉬운 해설을 구단의 이벤트·스폰서·ROI 액션으로 연결하는 MVP 프로토타입
...
5. 팬은 입덕패스에서 경기 summary, 선수 관전 포인트, 댓글 반응을 남기고 직관메이트 모집글을 작성합니다.
...
- 경기 선택
- 경기 summary와 오늘 잘한 선수 노출
- 하이라이트 메이커 내부 출전 선수 다중 선택
