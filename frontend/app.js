...
const FEATURED_FIBA_MATCH = {
  ...
  playerStats: {
    KR: [
      ["kor-2", "최준용", "FD", "2", 8, 2, 2, 1, 0, 0, "29:23", -6],
      ["kor-3", "박지훈", "GD", "3", 0, 1, 0, 0, 0, 0, "04:02", -10],
      ["kor-5", "변준형", "GD", "5", 3, 2, 8, 1, 1, 0, "19:21", 5],
      ["kor-6", "이정현", "GD", "6", 13, 1, 4, 2, 0, 0, "23:07", 2],
      ["kor-7", "유기상", "GD", "7", 10, 3, 1, 2, 0, 0, "20:28", -3],
      ["kor-11", "이우석", "GD", "11", 12, 6, 7, 1, 0, 0, "33:06", 2],
      ["kor-12", "문정현", "FD", "12", 0, 1, 1, 0, 0, 0, "04:21", 7],
      ["kor-22", "여준석", "FD", "22", 15, 8, 1, 0, 0, 0, "39:29", -8],
      ["kor-31", "장재석", "C", "31", 11, 10, 1, 0, 0, 0, "24:36", -5],
      ["kor-33", "이승현", "FD", "33", 4, 8, 1, 0, 2, 1, "20:24", 3],
      ["kor-36", "다니엘 에디", "C", "36", 4, 1, 0, 0, 1, 0, "06:43", 3],
    ],
  },
  inactivePlayers: {
    KR: [
      { pcode: "kor-21", name: "이두원", position: "C", backNumber: "21", reason: "FIBA boxscore Did Not Play" },
    ],
  },
  dashboardSignals: [
